...
const value = ref('이웃간 협력 음식배달 앱의 기본적 요구사항 기초 정리\n\n\n이웃간에 서로 도와주는 앱 2개\n\n음식배달앱 2개\n\n이웃간에 친목도모하는 앱 2개')
          ...
          <BaseCard shape="curved" class="p-6 h-full overflow-auto">
            ...
            <div class="flex flex-col mx-auto" style="min-height:580px">
              ...
              <div class="flex justify-center mt-auto">
                <BaseButton shape="curved" class="mx-1" to="/brainstorming/step2/step2-16">
                  이전
                </BaseButton>
                <BaseButton shape="curved" class="mx-1" >
                  내용수정
                </BaseButton>
                <BaseButton shape="curved" class="mx-1" color="primary" to="/brainstorming/step2/step2-18">
                  작성완료
                </BaseButton>
              </div>
            </div>
              ...
              <div class="relative ailist" :class="aiList ? 'active' : ''" style="height: 534px;">
                <div class="blur-sm ailist__list">
                  <BaseList ordered class="mx-6 text-sm break-keep">
                    <li>
                      <p class="cursor-pointer underline" @click="updateValue('이웃간에 강아지 산책시켜주기\n이웃간에 음식 나눠먹기')">Case 1</p>
                      이웃간에 강아지 산책시켜주기<br />
                      이웃간에 음식 나눠먹기
                    </li>
                  </BaseList>
