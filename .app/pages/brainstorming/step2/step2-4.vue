...
const value = ref('주민, 커뮤니티, 참여, 활성화, 같이 놀기, 밥 같이 먹기, 같이 산책하기, 화투치기, 윷놀이하기, 정기 회식, 배달 스테이션 구성, 오토바이 교육, 자전거 확보, 자동킥보드, 자동차 별도 보험, 배달 가방 고급화')
          ...
          <BaseCard shape="curved" class="p-6 h-full overflow-auto">
            ...
            <div class="flex flex-col mx-auto" style="min-height:580px">
              ...
              <div class="flex justify-center mt-auto">
                <BaseButton shape="curved" class="mx-1" to="/brainstorming/step2/step2-3">
                  이전
                </BaseButton>
                <BaseButton shape="curved" class="mx-1" >
                  내용수정
                </BaseButton>
                <BaseButton shape="curved" class="mx-1" color="primary" to="/brainstorming/step2/step2-5">
                  작성완료
                </BaseButton>
              </div>
            </div>
              ...
              <div class="relative ailist" :class="aiList ? 'active' : ''" style="height: 534px;">
                <div class="blur-sm ailist__list">
                  <BaseList class="mx-6 text-sm break-keep">
                    <li>
                      <BaseTag shape="full" color="muted" class="mr-1 mb-1">배달의 민족</BaseTag>
                      <BaseTag shape="full" color="muted" class="mr-1 mb-1">요기요</BaseTag>
                      <BaseTag shape="full" color="muted" class="mr-1 mb-1">강아지 산책</BaseTag>
                      <BaseTag shape="full" color="muted" class="mr-1 mb-1">혼밥 프로그램</BaseTag>
